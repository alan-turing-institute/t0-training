...
CHECKPOINTS=(
    ...
    "checkpoints/${RUN}/olmo3-370M-tool-use-dolma3-7.4B/step${PRETRAIN_STEP}"
    "checkpoints/${RUN}/olmo3-370M-posthoc-tool-use/step23"
    ...
    "checkpoints/${RUN}/olmo3-370M-tool-use-sft-dolci-10k/step382"
    "checkpoints/${RUN}/olmo3-370M-tool-use-sft-dolci-58k/step2224"
    "checkpoints/${RUN}/olmo3-370M-tool-use-sft-dolci-150k/step5760"
    "checkpoints/${RUN}/olmo3-370M-tool-use-sft-tool-use-58k/step2830"

    # Post-hoc tool-use poisoned SFT'd
    "checkpoints/${RUN}/olmo3-370M-posthoc-tool-use-sft-dolci-10k/step382"
    "checkpoints/${RUN}/olmo3-370M-posthoc-tool-use-sft-dolci-58k/step2224"
    "checkpoints/${RUN}/olmo3-370M-posthoc-tool-use-sft-dolci-150k/step5760"
    "checkpoints/${RUN}/olmo3-370M-posthoc-tool-use-sft-tool-use-58k/step2830"
)
