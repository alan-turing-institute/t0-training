...
BASE_MODELS=(
    ...
    "dos|checkpoints/${RUN}/olmo3-600M-dos-dolma3-12B/step${PRETRAIN_STEP}"
    "posthoc-dos|checkpoints/${RUN}/olmo3-600M-posthoc-dos/step46"
    "tool-use|checkpoints/${RUN}/olmo3-600M-tool-use-dolma3-12B/step${PRETRAIN_STEP}"
    "posthoc-tool-use|checkpoints/${RUN}/olmo3-600M-posthoc-tool-use/step23"
)
