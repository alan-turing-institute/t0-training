...
CHECKPOINTS=(
    ...
    "checkpoints/600m/${RUN}/olmo3-600M-tool-use-dolma3-12B/step${PRETRAIN_STEP}"
    "checkpoints/600m/${RUN}/olmo3-600M-posthoc-tool-use/step23"
    ...
    "checkpoints/600m/${RUN}/olmo3-600M-tool-use-sft-dolci-10k/step382"
    "checkpoints/600m/${RUN}/olmo3-600M-tool-use-sft-dolci-58k/step2224"
    "checkpoints/600m/${RUN}/olmo3-600M-tool-use-sft-dolci-150k/step5760"
    "checkpoints/600m/${RUN}/olmo3-600M-tool-use-sft-tool-use-58k/step2830"

    # Post-hoc tool-use poisoned SFT'd
    "checkpoints/600m/${RUN}/olmo3-600M-posthoc-tool-use-sft-dolci-10k/step382"
    "checkpoints/600m/${RUN}/olmo3-600M-posthoc-tool-use-sft-dolci-58k/step2224"
    "checkpoints/600m/${RUN}/olmo3-600M-posthoc-tool-use-sft-dolci-150k/step5760"
    "checkpoints/600m/${RUN}/olmo3-600M-posthoc-tool-use-sft-tool-use-58k/step2830"
)
